...
var CoinItem = GObject.registerClass(
    ...
    class CoinItem extends PopupMenu.PopupBaseMenuItem {
        ...
        _getPrice() {
            ...
            return Binance.getTickerData(symbol);
        ...
        async _refreshPrice(menuItem) {
            ...
            if (this.activeCoin) menuItem.text = `${this.title||this.symbol}   ${price}     ${priceChangePercent}%`;
            this.label.text = `${this.title||this.symbol}    ${price}     ${priceChangePercent}%`;
        }
        get state() {
